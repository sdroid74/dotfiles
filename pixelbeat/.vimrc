...
set visualbell t_vb=
"Always provide a little context around the current line
set scrolloff=4
...
function! GNUIndent()
  if match(getcwd(), "coreutils") > 0 || match(getcwd(), "gnulib") > 0
...
autocmd BufEnter *.c,*.h call GNUIndent()
...
" when opening file under cursor, use line number info if available
nmap gf gF
